    ...
    <div className='flex mt-10 flex-col-reverse lg:flex-row text-white'>
      <div className='flex-1 flex flex-col gap-4 pt-4 lg:pt-10'>
        ...
        <span className='text-sm text-gray-200'>
          As a passionate and enthusiastic engineer, I thrive on solving challenging problems and
          exploring new technologies. My contributions to open sources such as Npm and Stack
          Overflow reflect my love for learning and sharing knowledge. In my free time, I enjoy
          ...
          <div className='flex gap-4'>
            <div className='flex flex-col lg:flex-row items-start lg:items-center'>
              ...
              <div className='max-w-[105px] ml-0 lg:ml-3'>
                <span className='text-xs leading-none'>Years of experience</span>
              </div>
            </div>
            ...
            <div className='flex flex-1 justify-between gap-3 flex-col lg:flex-row'>
              <div className='flex flex-col gap-2 justify-center lg:ml-3'>
                ...
                <span className='text-xs text-amber-600'>rajeshkumaran1996@gmail.com</span>
              </div>
              <div className='flex gap-3 '>
                {[
                  { image: Linkedin, link: 'https://www.linkedin.com/in/rajeshk07/' },
                  {
                    image: Github,
      ...
      <div className='flex-1 flex lg:justify-end'>
        <Image src={Photo} alt='Rajesh' className='max-w-[100px] lg:max-w-[450px]' />
      </div>
    </div>
  );
};
